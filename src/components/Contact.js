        ...
        <div>
            <section className="bg-light" id="contact">
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-6 mb-0 mb-lg-0">
                        ...
                        <div className="col-lg-3 col-md-6 mb-0 mb-lg-0"><a className="px-4 py-5 text-center contact-item shadow-sm d-block reset-anchor" href="mailto:jsmayankyadav@gmail.com"><i className="fas fa-envelope fa-2x mb-4"></i>
